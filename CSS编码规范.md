...
　　[2.7 注释](#27-%E6%B3%A8%E9%87%8A)

　　[2.8 命名](#28-%E5%91%BD%E5%90%8D)
...
#### [强制] 注释统一用'/* */'（scss中也不要用'//'）。缩进与下一行代码保持一致；可位于一个代码行的末尾，与代码间隔一个空格。
...
#### [强制] 类名使用小写字母，以中划线分隔；id采用驼峰式命名；scss中的变量、函数、混合、placeholder采用驼峰式命名
