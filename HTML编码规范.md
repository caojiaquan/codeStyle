...
　　[5.3 可访问性 (A11Y)](#53-%E5%8F%AF%E8%AE%BF%E9%97%AE%E6%80%A7-a11y)
...
#### [强制] 使用 `2` 个空格做为一个缩进层级，不允许使用 `4` 个空格 或 `tab` 字符。嵌套的节点应该缩进。
...
```html
<script src="//xxx.weibo.com/xxxxx/jquery-1.10.2.min.js"></script>
```
